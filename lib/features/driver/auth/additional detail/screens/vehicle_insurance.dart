...
class AdditionDetailVehicleInsurance extends StatefulWidget {
  ...
  @override
  State<AdditionDetailVehicleInsurance> createState() =>
      _AdditionDetailVehicleInsuranceState();
}

class _AdditionDetailVehicleInsuranceState
    extends State<AdditionDetailVehicleInsurance> {
  File? selectedFile;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    TextWidget(
                      text: "Upload car insurance for verification",
